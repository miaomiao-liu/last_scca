...
increUpdate=('s_eseal_info') #增量更新的表
...
echo "==============================================================" >> ${updateETLLog}
echo "`date "+%Y-%m-%d %H:%M:%S"` s_eseal_info update begin" >> ${updateETLLog}
...
echo "`date "+%Y-%m-%d %H:%M:%S"` s_eseal_info update scccess" >> ${updateETLLog}
echo "==============================================================" >> ${updateETLLog}
