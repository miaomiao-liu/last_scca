...
increUpdate=('cert_use_info') #增量更新的表
...
echo "==============================================================" >> ${updateETLLog}
echo "`date "+%Y-%m-%d %H:%M:%S"` cert_use_info update begin" >> ${updateETLLog}
...
echo "`date "+%Y-%m-%d %H:%M:%S"` cert_use_info update scccess" >> ${updateETLLog}
echo "==============================================================" >> ${updateETLLog}
