...
increUpdate=('work_deal_info') #增量更新的表
...
echo "==============================================================" >> ${updateETLLog}
echo "`date "+%Y-%m-%d %H:%M:%S"` work_deal_info update begin" >> ${updateETLLog}
...
echo "`date "+%Y-%m-%d %H:%M:%S"` work_deal_info update scccess" >> ${updateETLLog}
echo "==============================================================" >> ${updateETLLog}
